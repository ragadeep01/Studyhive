...
const Home = () => {
  return (
    <section className="min-h-screen bg-gradient-to-b from-[#212A3E] via-indigo-100 to-white text-gray-800 ">
      {/* Hero Section */}
      <section id="hero" className="relative bg-[#212A3E]  text-white py-24">
        <div className="text-center max-w-2xl mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-extrabold leading-tight mb-4">Boost Your Learning with StudyHive</h1>
          <p className="text-lg md:text-xl mb-6">Challenge yourself with engaging quizzes & master new skills.</p>
          <a
            href="signup.html"
            className="px-8 py-3 bg-white text-[#212A3E] font-semibold rounded-lg shadow-lg hover:bg-gray-400 transition-all duration-300"
          >
            Get Started
          </a>
        </div>
      ...
      <section id="howwork" className="py-20 px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center p-6 bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow">
            <FontAwesomeIcon icon={faUserPlus} className="text-4xl text-[#394867] mb-4" />
            <h3 className="text-xl font-bold mb-2">Sign Up</h3>
            <p>Create your free account & start learning.</p>
          </div>
          <div className="text-center p-6 bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow">
            <FontAwesomeIcon icon={faBookOpen} className="text-4xl text-[#394867] mb-4" />
            <h3 className="text-xl font-bold mb-2">Pick a Subject</h3>
            <p>Choose from various subjects & topics.</p>
          </div>
          <div className="text-center p-6 bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow">
            <FontAwesomeIcon icon={faGamepad} className="text-4xl text-[#394867] mb-4" />
            <h3 className="text-xl font-bold mb-2">Play & Learn</h3>
            <p>Test your knowledge with quizzes & challenges.</p>
          </div>
        </div>
      ...
      {/* Why Choose Us Section */}
      <section id="why" className="py-20 px-6 md:px-12">
        <h1 className="text-3xl font-extrabold text-center mb-8">Why Choose StudyHive?</h1>
        <ul className="space-y-4 text-lg text-gray-700">
          <li>
            <span className="text-green-600 font-bold">✔️</span> Fun & Interactive Learning
          </li>
